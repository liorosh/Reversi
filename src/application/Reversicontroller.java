...
String id;
	...
	id="s"+Integer.toString(x)+"_"+Integer.toString(y);
	if((x+y)%2==0)
		setBackground(null);
    	else
...
/*maybe switch to working with a matrix, and color the pieces according to the matrix, it'll be easier
 * should check it in the morning, after updating the matrix that a click has been made, update the matrix, go through all of it and switch colors*/
